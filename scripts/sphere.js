(function (global, factory) {
    ...
    */
    ...
    if (self.config.useItemInlineStyles) {
      ...
      itemEl.style.webkitFilter = 'alpha(opacity=0)'
      itemEl.style.opacity = 0;
      var transformOrigin = '50% 50%';
      itemEl.style.WebkitTransform = transformOrigin;
      ...
      itemEl.style.setProperty('-ms-transform-origin',transformOrigin)
      var transform = 'translate3d(-50%, -50%, 0) scale(1)';
      itemEl.style.WebkitTransform = transform;
      itemEl.style.MozTransform = transform;
      itemEl.style.OTransform = transform;
      itemEl.style.transform = transform;
      itemEl.style.setProperty('-ms-transform',transform)
    ...
    TagCloud._on(self.$el, 'mousedown', function () {
      self.active = true;
    }); // mouseout

    TagCloud._on(self.$el, 'mouseup', function () {
      self.active = false;
    }); // mousemove
